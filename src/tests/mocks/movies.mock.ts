export const POPULAR_MOVIES_RESULT_MOCK = {
    page: 1,
    results: [
        {
            adult: false,
        ...
        {
            adult: false,
            backdrop_path: '/bSRApHFarrUjYlsrGfi6qma9pEZ.jpg',
            genre_ids: [28, 53],
            id: 359410,
            original_language: 'en',
        ...
        },
        {
            ...
            overview:
                'Following their explosive showdown, Godzilla and Kong must reunite against a colossal undiscovered threat hidden within our world, challenging their very existence – and our own. Watch Here : https://ln.run/2CILg',
            popularity: 2461.857,
